...
<head>
	...
	<script type="text/javascript" src="js/controller/itemController.js"></script>5
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									<#list itemImages as list>
									<li><img src="${list.url}" bimg="${list.url}" onmousemove="preview(this)" /></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
...
购热销商品</em>
					...
					<div class="clearfix choose">
						...
						<#list specificationItems as list>
							<dl>
								<dt>
									<div class="fl title">
									<i>${list.attributeName}</i>
								</div>
								</dt>
								<#--<dd><a href="javascript:;" class="selected">金色<span title="点击取消选择">&nbsp;</span>-->
</a></dd>
								<#list list.attributeValue as value>
								<dd><a href="javascript:;" class="{{isSelected('${list.attributeName}','${value}')?'selected':''}}" ng-click="selectIn('${list.attributeName}','${value}')"><span title="点击取消选择">&nbsp;</span>${value}</a></dd>
								</#list>
							</dl>
						</#list>
						</div>
